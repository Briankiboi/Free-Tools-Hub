...
window.renderSiteHeader = (function () {
    ...
    var TABS = [
        ['https://briankiboi.is-a.dev/#svc-rate-section', 'Rate Card'],
        ['https://briankiboi.is-a.dev/#projects',        'Projects'],
        ['https://briankiboi.is-a.dev/#services',        'My Services'],
        ['https://briankiboi.is-a.dev/#contact',         'Contact']
    ];

    var DRAWER_LINKS = [
        ['https://briankiboi.is-a.dev/#about',        'About Me'],
        ['https://briankiboi.is-a.dev/#tech-stack',   'Tech Stack'],
        ['https://briankiboi.is-a.dev/#work',         'Experience'],
        ['https://briankiboi.is-a.dev/#projects',     'Projects'],
        ['https://briankiboi.is-a.dev/#services',     'Services'],
        ['https://briankiboi.is-a.dev/#contact',      'Contact']
    ];
    ...
    function renderHeader(root) {
        var tabs = TABS.map(function (t) {
            return '<li class="hub-pt-tab-item"><a href="' + t[0] + '" target="_blank" rel="noopener" class="nav-tab">' + t[1] + '</a></li>';
        }).join('');
        var drawer = DRAWER_LINKS.map(function (t) {
            return '<a href="' + t[0] + '" target="_blank" rel="noopener" class="hub-drawer-link">' + t[1] + '</a>';
        }).join('');
